...
public class TasksController {
    ...
    @PostMapping
    public TaskDTO createTask(Principal principal, @Valid @RequestBody InputDTO inputDTO) {
        log.debug("createTask username={} message={}", principal.getName(), inputDTO.getMessage());
        Task createdTask = taskService.plan(principal.getName(), inputDTO.getMessage(), new HashMap<>());
